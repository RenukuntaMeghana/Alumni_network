...
function AlumniLogin(props) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      const response = await fetch('http://localhost:8000/AlumniLogin1', {
        method: 'POST',
        headers: {
  ...
  return (
    <div>
      <div className="cen container-lg">
        <br/>
        <p className="h4 pb-3 text-center">Please login to your account as Alumni</p>
        <div className="me">
          <div className="box container-lg">
            <form action="/AlumniLogin1" method="post" onSubmit={handleSubmit}>
              <div className="lc">
              ...
              <button type="submit" className="btn btn-primary" href="AlumniLogin">
                Log In
                </button>
                <br />
        ...
        <div className="d-flex align-items-center justify-content-center pb-4 pt-3">
          ...
          <a href="AlumniRegister" className="btn">
            Register Now
          </a>
        </div>
      </div>
