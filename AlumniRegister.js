...
function AlumniRegister(props) {
  ...
  //   const response = await axios.post('http://localhost:8000/AlumniRegister1', data);
  ...
  async function handleSubmit(event) {
    ...
    try {
      const response = await fetch('http://localhost:8000/AlumniRegister1', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        // localStorage.setItem('user',response.body.firstName)
    ...
    <div>
      <div class="register container"  style={{backgroundColor:"white"}}>
         <div class="text-center">
             <h2 class="display-2">ALUMNI REGISTER</h2>
         </div>
         <div class="card mx-auto" style={{width:"65%"}}>
          <div class="card-body">
            ...
            <label htmlFor="firstName">First Name</label>
              ...
              <button type="submit" className="btn me-auto ms-auto" href="AlumniLogin" id="registerbtn">
                Register
              </button>
              </div>
...
//         <div class="card mx-auto" style={{width:"65%"}}>
//             <div class="card-body">
//                 <form action="http://localhost:8000/AlumniRegister1" method="post">
//                     <div className="d-flex">
